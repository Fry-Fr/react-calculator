...
import { addOne, applyNumber, changeOperation, clearDisplay, memoryIsTotal, memoryApplied, memoryClear } from './actions';
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={()=> dispatch(memoryIsTotal())} />
              <CalcButton value={"MR"} onClick={()=> dispatch(memoryApplied())} />
